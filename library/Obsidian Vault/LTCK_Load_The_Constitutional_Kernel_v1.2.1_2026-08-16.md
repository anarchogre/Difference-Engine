...
**Supersedes:** LTCK v1.2.0, LTCK v1.0.0, and interim v1.1 work  
...
## 5.1 Machine-level filesystem census

When a full machine/user-space census is genuinely `NEW`, begin from:

```text
/home
```

not from one guessed Difference Engine subdirectory.

Enumerate the complete relevant home surface.
